 ...
 */
public class PaymentChannelClientConnection_old {
    // Various futures which will be completed later
    private final SettableFuture<PaymentChannelClientConnection_old> channelOpenFuture = SettableFuture.create();
     ...
     */
    public PaymentChannelClientConnection_old(InetSocketAddress server, int timeoutSeconds, Wallet wallet, ECKey myKey,
                                              Coin maxValue, String serverId) throws ValueOutOfRangeException {
    ...
    public PaymentChannelClientConnection_old(InetSocketAddress server, int timeoutSeconds, Wallet wallet, ECKey myKey,
        ...
        channelClient = new PaymentChannelClient(wallet, myKey, maxValue, Sha256Hash.create(serverId.getBytes()), timeWindow,
            ...
            public void channelOpen(boolean wasInitiated) {
                ...
                channelOpenFuture.set(PaymentChannelClientConnection_old.this);
            }
        });
     ...
     * {@link org.bitcoinj.protocols.channels.PaymentChannelClientConnection_old#incrementPayment(Coin)} or {@link org.bitcoinj.protocols.channels.PaymentChannelClientConnection_old#incrementPayment(Coin, ByteString)} to begin paying the server.</p>
     */
    public ListenableFuture<PaymentChannelClientConnection_old> getChannelOpenFuture() {
     ...
     *                                  ({@link org.bitcoinj.protocols.channels.PaymentChannelClientConnection_old#state()}.getTotalValue())
     * @throws IllegalStateException If the channel has been closed or is not yet open
     *                               (see {@link org.bitcoinj.protocols.channels.PaymentChannelClientConnection_old#getChannelOpenFuture()} for the second)
     */
