...
public class PaymentChannelClient implements IPaymentChannelClient
{
    ...
    @GuardedBy("lock")
    private void receivePrice(Protos.TwoWayChannelMessage priceMsg) throws VerificationException
    {
        // TODO: waht
    }
     ...
     * {@link ClientConnection#destroyConnection(network.bitmesh.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link ClientConnection#destroyConnection(network.bitmesh.channels.PaymentChannelCloseException.CloseReason)} to settle the connection, it does not
