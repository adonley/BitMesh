...
public abstract class ServerConnectionEventHandler {
    ...
    public synchronized void setConnectionChannel(@Nullable ProtobufParser<Protos.TwoWayChannelMessage> connectionChannel) { this.connectionChannel = connectionChannel; }

    /**
     * <p>Closes the channel with the client (will generate a
     * {@link org.bitcoinj.protocols.channels.ServerConnectionEventHandler#channelClosed(PaymentChannelCloseException.CloseReason)} event)</p>
     *
     ...
     * {@link org.bitcoinj.protocols.channels.ServerConnectionEventHandler#channelOpen(Sha256Hash)}</p>
     */
