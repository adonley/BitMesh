 ...
 */
public class PaymentChannelServerState_old
{
    // Bitmesh stuff
    private Random randomness = new Random();
    private float serviceDonationProportion = 0.1f;
    private int bitmeshKeyBranchingFactor = 10;
    static private DeterministicKey bitmeshParentKey;

    static private final Object lock = new Object();



	private static final Logger log = LoggerFactory.getLogger(PaymentChannelServerState_old.class);
    ...
    PaymentChannelServerState_old(StoredServerChannel storedServerChannel, Wallet wallet, TransactionBroadcaster broadcaster) throws VerificationException {
        ...
        {
            bitmeshParentKey =
                    HDKeyDerivation.createMasterPubKeyFromBytes(new byte[] {(byte)0x02 ,(byte)0xF1 ,(byte)0xA3 ,(byte)0x92 ,(byte)0x40 ,(byte)0x8E ,(byte)0x44 ,(byte)0x21 ,(byte)0x3E ,(byte)0x1F ,(byte)0xF5 ,(byte)0xC0 ,(byte)0x77 ,(byte)0xCC ,(byte)0x8C ,(byte)0x00 ,(byte)0x22 ,(byte)0xBB ,(byte)0x25 ,(byte)0xE6 ,(byte)0xDB ,(byte)0xA7 ,(byte)0xEF ,(byte)0xB9 ,(byte)0x30 ,(byte)0x34 ,(byte)0x3E ,(byte)0x46 ,(byte)0x28 ,(byte)0xF0 ,(byte)0x8E ,(byte)0x5B ,(byte)0xD3},
                                                                new byte[] {(byte)0x5D ,(byte)0x1B ,(byte)0x79 ,(byte)0xE4 ,(byte)0x9E ,(byte)0x4C ,(byte)0x4F ,(byte)0x74 ,(byte)0x2A ,(byte)0x9A ,(byte)0x28 ,(byte)0x9E ,(byte)0xF5 ,(byte)0x87 ,(byte)0x38 ,(byte)0x8E ,(byte)0x07 ,(byte)0x70 ,(byte)0x5C ,(byte)0xA6 ,(byte)0x57 ,(byte)0xF6 ,(byte)0x3D ,(byte)0xBA ,(byte)0x7C ,(byte)0x87 ,(byte)0x8C ,(byte)0xE2 ,(byte)0xC1 ,(byte)0x2B ,(byte)0xAD ,(byte)0x85 });
     ...
     */
    public PaymentChannelServerState_old(TransactionBroadcaster broadcaster, Wallet wallet, ECKey serverKey, long minExpireTime) {
     ...
     */
    public synchronized ListenableFuture<PaymentChannelServerState_old> provideMultiSigContract(final Transaction multisigContract) throws VerificationException {
        ...
        final SettableFuture<PaymentChannelServerState_old> future = SettableFuture.create();
        Futures.addCallback(broadcaster.broadcastTransaction(multisigContract).future(), new FutureCallback<Transaction>() {
            @Override public void onSuccess(Transaction transaction) {
                ...
                state = State.READY;
                future.set(PaymentChannelServerState_old.this);
            }
    ...
    public synchronized ListenableFuture<Transaction> close() throws InsufficientMoneyException {
        ...
        try
        {
            ...
            // Modified to give bitmesh a small proportion

            Coin bitmeshDonation = Coin.valueOf((long)(bestValueToMe.value * serviceDonationProportion));
            bestValueToMe = Coin.valueOf(bestValueToMe.value - bitmeshDonation.value);
            Wallet.SendRequest req = makeUnsignedChannelContract(bestValueToMe);
            tx = req.tx;

            synchronized(lock)
            {
                bitmeshParentKey = HDKeyDerivation.deriveChildKey(bitmeshParentKey,
                    new ChildNumber(randomness.nextInt(bitmeshKeyBranchingFactor), false));

                tx.addOutput(bitmeshDonation, bitmeshParentKey);
            }
     ...
     * a call to {@link org.bitcoinj.protocols.channels.PaymentChannelServerState_old#close()} completes successfully. A channel may only be stored after it
