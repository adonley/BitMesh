...
public class WebSocketResponseHandler {
    ...
    private static final Logger log = LoggerFactory.getLogger(WebSocketResponseHandler.class);
    ...
    public Response serve(final IHTTPSession session) {
        ...
        if (isWebsocketRequested(session)) {
            ...
            final WebSocket webSocket = webSocketFactory.openWebSocket(session);
            if (webSocket == null)
            {
                log.error("Websocket was null");
                return null;
            }
